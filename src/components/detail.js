...
import {
  ...
  ExpandLess, BookmarkBorderSharp, BorderColor
...
class Detail extends Component {
  ...
  render() {
    ...
    const PageUp = () => {
      ...
      useEffect(() => {
        documentRef.current.addEventListener('scroll', handleUpScroll);
        return () => documentRef.current.removeEventListener('scroll', handleUpScroll);
      }, [pageY]);
