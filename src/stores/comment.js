...
export default class CounterStore {
  ...
  @action
  getList = (i) => {
    let url = "http://3.128.62.155:8080/Team5Spring/comment/list";
  ...
  @action
  handleSubmit = () => {
    let url = "http://3.128.62.155:8080/Team5Spring/comment/regist";
  ...
  @action
  deleteComment = () => {
    let url = "http://3.128.62.155:8080/Team5Spring/comment/delete";
