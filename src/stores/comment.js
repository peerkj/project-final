...
export default class CounterStore {
  ...
  @action
  getList = (i) => {
    let url = "http://13.124.83.195:8080/acorn/comment/list";
  ...
  @action
  handleSubmit = () => {
    let url = "http://13.124.83.195:8080/acorn/comment/regist";
  ...
  @action
  deleteComment = () => {
    let url = "http://13.124.83.195:8080/acorn/comment/delete";
