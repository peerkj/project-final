...
export default class DragStore {
  ...
  @action
  handleAddFood = () => {
    let url = "http://18.221.230.63:8080/acorn/refri/put";
  ...
  handleListFood = () => {
    let url =
      "http://18.221.230.63:8080/acorn/refri/list?email=" +
  ...
  @action
  refri_delete = (num) => {
    let url = "http://18.221.230.63:8080/acorn/refri/delete?refrig_num=" + num;
    axios({
      method: "get",
      url: url,
    })
  ...
  handleCook = () => {
    this.sw = 1;
    let url = "http://18.221.230.63:8080/acorn/refri/search";
