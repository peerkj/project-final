...
export default class CounterStore {
  ...
  setNickname = (nick, history) => {
    ...
    let url = "http://13.124.83.195:8080/acorn/chef/mypage";
    //유효성 검사
    axios({
      method: "get",
      url: url,
  ...
  updateCount = (rec_num, idx) => {
    let url = "http://13.124.83.195:8080/acorn/recipe/count?rec_num=" + rec_num;
    //유효성 검사
    axios({
      method: "get",
      url: url,
  ...
  getList = () => {
    ...
    let url = "http://13.124.83.195:8080/acorn/mypage/recipe";
    axios({
      method: "get",
      url: url,
      params: {
  ...
  getList_scrap = () => {
    if (this.list.length === this.list_count) return;
    let url = "http://13.124.83.195:8080/acorn/mypage/scrap";
    axios({
      method: "get",
      url: url,
      params: {
  ...
  deleteRecipe = () => {
    let url =
      "http://13.124.83.195:8080/acorn/recipe/delete?rec_num=" +
