...
export default class CounterStore {
  ...
  setNickname = (nick, history) => {
    ...
    let url = "http://3.128.62.155:8080/Team5Spring/chef/mypage";
    //유효성 검사
    axios({
      method: "get",
      url: url,
  ...
  getList = () => {
    ...
    let url = "http://3.128.62.155:8080/Team5Spring/mypage/recipe";
    axios({
      method: "get",
      url: url,
      params: {
  ...
  getList_scrap = () => {
    if (this.list.length === this.list_count) return;
    let url = "http://3.128.62.155:8080/Team5Spring/mypage/scrap";
    axios({
      method: "get",
      url: url,
      params: {
  ...
  @action
  checkNews = () => {
    let url = "http://3.128.62.155:8080/Team5Spring/connect/newscheck";
  ...
  @action
  onNews = () => {
    let url = "http://3.128.62.155:8080/Team5Spring/connect/onnews";
