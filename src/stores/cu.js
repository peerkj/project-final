...
export default class CU {
  ...
  @observable
  imgBase64 = `http://3.128.62.155:8080/Team5Spring/image/profile/${this.root.info.profile_name}`;
  @observable
  menu_profile = `http://3.128.62.155:8080/Team5Spring/image/profile/${
  ...
  reLoadState = () => {
    ...
    this.imgBase64 = `http://3.128.62.155:8080/Team5Spring/image/profile/${this.root.info.profile_name}`;
    if (this.root.info.profile_name === "basic_user.png") {
      this.menu_profile = `http://3.128.62.155:8080/Team5Spring/image/profile/basic_user2.png`;
    } else
      this.menu_profile = `http://3.128.62.155:8080/Team5Spring/image/profile/${this.root.info.profile_name}`;
  };
  ...
  @action
  checkNickname = () => {
    let url = "http://3.128.62.155:8080/Team5Spring/chef/checknick";
  ...
  handleSubmit = (history) => {
    let url = "http://3.128.62.155:8080/Team5Spring/chef/mod";
